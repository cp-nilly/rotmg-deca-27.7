package kabam.lib.console.view
{
    ...
    public final class ConsoleOutputMediator extends Mediator
    {
        ...
        private function onLog(_arg1:String):void
        {
            this.view.log(_arg1);
        }

        private function onWatch(_arg1:Watch):void
        {
            this.view.watch(_arg1);
        }

        private function onUnwatch(_arg1:String):void
        {
            this.view.unwatch(_arg1);
        }
