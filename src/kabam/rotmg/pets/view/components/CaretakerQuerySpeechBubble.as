package kabam.rotmg.pets.view.components
{
    ...
    public class CaretakerQuerySpeechBubble extends Sprite
    {
        ...
        {
            var _local2:TextFieldDisplayConcrete = new TextFieldDisplayConcrete().setSize(16).setAutoSize(TextFieldAutoSize.CENTER).setVerticalAlign(VerticalAlign.MIDDLE).setPosition(
