package kabam.rotmg.pets.view.components
{
    ...
    public class FameOrGoldBuyButtons extends Sprite
    {
        ...
        public function setGoldPrice(_arg1:int):void
        {
            this.goldButton.setPrice(_arg1, Currency.GOLD);
        ...
        {
            this.prefix.setStringBuilder(new LineBuilder().setParams(_arg1));
        ...
        public function setFamePrice(_arg1:int):void
        {
            this.fameButton.setPrice(_arg1, Currency.FAME);
        ...
        private function onFameClick(_arg1:MouseEvent):void
        {
            if (!this.disabled)
            {
        ...
        private function onGoldClick(_arg1:MouseEvent):void
        {
            if (!this.disabled)
            {
