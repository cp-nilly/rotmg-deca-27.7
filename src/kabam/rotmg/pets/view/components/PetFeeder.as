package kabam.rotmg.pets.view.components
{
    ...
    public class PetFeeder extends Sprite 
    {
        ...
        public function initialize(_arg1:PetSlotsState):void
        {
            this.state = _arg1;
        ...
        private function onFoodLoaded(_arg1:int):void
        {
            this.state.rightSlotItemId = _arg1;
            this.update();
        }
        ...
        {
            this.rightSlot.setProcessing(_arg1);
            this.leftSlot.setProcessing(_arg1);
            if (_arg1)
            {
                this.arrow.highlight(false);
