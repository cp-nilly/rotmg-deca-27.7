package kabam.rotmg.pets.view.components
{
    ...
    public class PetAbilityDisplay extends Sprite
    {
        ...
        public function PetAbilityDisplay(_arg1:AbilityVO, _arg2:int)
        {
            this.vo = _arg1;
            this.spacing = _arg2;
            this.rollOver = new NativeSignal(this, MouseEvent.MOUSE_OVER).add(this.onRollOver);
            this.textColor = ((_arg1.getUnlocked()) ? 0xB3B3B3 : 0x666666);
            this.updateTextFields();
            this.makeBullet();
            _arg1.updated.add(this.onUpdated);
        }
        ...
        private function onUpdated(_arg1:AbilityVO):void
        {
            this.setLevelText();
        }
