package kabam.rotmg.messaging.impl
{
    ...
    public class GameServerConnectionConcrete extends GameServerConnection 
    {
        ...
        {
            var _local2:CharacterSkin = this.classesModel.getCharacterClass(this.model.player.objectType_).skins.getSkin(_arg1.skinID);
            ...
            for each (_local7 in _arg2)
            {
                ...
                switch (_local7.statType_)
                {
                    ...
                    case StatData.INVENTORY_11_STAT:
                        _arg1.equipment_[(_local7.statType_ - StatData.INVENTORY_0_STAT)] = _local8;
                        break;
                    ...
                    case StatData.TEXTURE_STAT:
                        ((!((_local4.skinId == _local8))) && (this.setPlayerSkinTemplate(_local4, _local8)));
                        break;
                    ...
                    case StatData.BACKPACK_7_STAT:
                        _local9 = (((_local7.statType_ - StatData.BACKPACK_0_STAT) + GeneralConstants.NUM_EQUIPMENT_SLOTS) + GeneralConstants.NUM_INVENTORY_SLOTS);
                        (_arg1 as Player).equipment_[_local9] = _local8;
                        break;
