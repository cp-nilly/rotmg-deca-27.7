package kabam.rotmg.ui.view.components
{
    ...
    public class PotionSlotMediator extends Mediator
    {
        ...
        private function onDrop(_arg1:DisplayObject):void
        {
            ...
            {
                GameServerConnection.instance.invDrop(
                        _local2, PotionInventoryModel.getPotionSlot(this.view.objectType), this.view.objectType
                );
            }
            else
            {
                if ((_local3 is InteractiveItemTile))
                {
                    ...
                    if ((((_local4.getItemId() == ItemConstants.NO_ITEM)) && (!((_local4.ownerGrid.owner == _local2)))))
                    {
                        GameServerConnection.instance.invSwapPotion(
                                _local2,
                                _local2,
                                PotionInventoryModel.getPotionSlot(this.view.objectType),
                                this.view.objectType,
                                _local4.ownerGrid.owner,
                                _local4.tileId,
