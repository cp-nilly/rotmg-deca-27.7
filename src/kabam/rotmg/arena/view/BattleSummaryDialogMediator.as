package kabam.rotmg.arena.view
{
    ...
    public class BattleSummaryDialogMediator extends Mediator 
    {
        ...
        override public function initialize():void
        {
            ...
            var _local1:Boolean = (((this.bestRunModel.entry.currentWave > this.currentRunModel.entry.currentWave)) || ((((this.bestRunModel.entry.currentWave == this.currentRunModel.entry.currentWave)) && ((this.bestRunModel.entry.runtime < this.currentRunModel.entry.runtime)))));
            var _local2:ArenaLeaderboardEntry = ((_local1) ? this.bestRunModel.entry : this.currentRunModel.entry);
            this.view.setBestRun(_local2.currentWave, _local2.runtime);
        ...
        private function showBattleSummaryDialog(_arg1:TimerEvent):void
        {
