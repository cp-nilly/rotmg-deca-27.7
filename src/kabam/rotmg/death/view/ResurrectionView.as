package kabam.rotmg.death.view
{
    ...
    public class ResurrectionView extends Sprite
    {
        ...
        private function createBackground(_arg1:BitmapData):void
        {
            var _local4:Bitmap;
            var _local2:Array = [
                0.33, 0.33, 0.33, 0, 0, 0.33, 0.33, 0.33, 0, 0, 0.33, 0.33, 0.33, 0, 0, 0.33, 0.33, 0.33, 1, 0
            ];
        ...
        public function createPopup():void
        {
            this.popup = new Dialog(
                    TextKey.RESURRECTION_VIEW_YOU_DIED,
                    TextKey.RESURRECTION_VIEW_DEATH_TEXT,
                    TextKey.RESURRECTION_VIEW_SAVE_ME,
                    null,
                    null
            );
