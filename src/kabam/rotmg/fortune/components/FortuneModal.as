package kabam.rotmg.fortune.components
{
    ...
    public class FortuneModal extends EmptyFrame 
    {
        ...
        public static function doEaseOutInAnimation(_arg1:DisplayObject, _arg2:Object=null, _arg3:Object=null, _arg4:Function=null):void
        {
        ...
        private function onSmallBallClickComplete(_arg1:Boolean, _arg2:*):void
        {
            ...
            else
            {
                ...
                if (this.state == STATE_ROUND_1)
                {
                    _local4.dispatch(new DebugDialog("You have run out of time to choose, but an item has been chosen for you.", "Oh no!"));
                }
                else
                {
