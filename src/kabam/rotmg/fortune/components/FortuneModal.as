package kabam.rotmg.fortune.components
{
    ...
    public class FortuneModal extends EmptyFrame
    {
        ...
        public function FortuneModal(_arg1:GameSprite = null)
        {
        ...
        public static function doEaseOutInAnimation(
                _arg1:DisplayObject, _arg2:Object = null, _arg3:Object = null, _arg4:Function = null
        ):void
        {
            var _local5:GTween = new GTween(_arg1, (0.5 * 1), _arg2, {"ease": Sine.easeOut});
            _local5.nextTween = new GTween(_arg1, (0.5 * 1), _arg3, {"ease": Sine.easeIn});
            _local5.nextTween.paused = true;
            _local5.nextTween.end();
            _local5.nextTween.onComplete = _arg4;
        }

        private function displayInfoHover(_arg1:MouseEvent):void
        {
        ...
        private function InitTexts():void
        {
            ...
            var _local1:Vector.<String> = Vector.<String>(
                    [
                        "HOW WILL YOU PLAY?",
                        "THE FIVE MASTERS OF GOZOR WILL DETERMINE YOUR PRIZE!",
                        "HERE'S WHAT YOU CAN WIN!",
                        "Shuffling!",
                        "PICK ONE TO WIN A PRIZE!",
                        "YOU WON! ITEMS WILL BE PLACED IN YOUR GIFT CHEST",
                        "TWO ITEMS LEFT! TAKE ANOTHER SHOT!",
                        "PICK A SECOND PRIZE!",
                        "PLAY AGAIN?",
        ...
        private function setString(_arg1:int):void
        {
            ...
            _local2.y = (((modalHeight * 66) / 75) - (_local2.height / 2));
            addChild(texts_[this.currentString]);
        }

        private function destruct(_arg1:Event):void
        {
        ...
        {
            var _local5:ItemWithTooltip;
            this.tooltipItemIDIndex++;
            if (this.tooltipItems == null)
            {
                this.tooltipItems = Vector.<ItemWithTooltip>(
                        [
                            new ItemWithTooltip(
                                    this.fortuneInfo._rollsWithContentsUnique[this.tooltipItemIDIndex], ITEM_SIZE_IN_MC
                            ), new ItemWithTooltip(
                                this.fortuneInfo._rollsWithContentsUnique[(this.tooltipItemIDIndex + 1)],
                                ITEM_SIZE_IN_MC
                        )
                        ]
                );
            ...
            var _local3:ItemWithTooltip = new ItemWithTooltip(
                    this.fortuneInfo._rollsWithContentsUnique[this.tooltipItemIDIndex], ITEM_SIZE_IN_MC, true
            );
            _local3.onMouseOver.add(this.onItemSwitchPause);
            _local3.onMouseOut.add(this.onItemSwitchContinue);
            _local3.setXPos(this.crystalMain.getCenterX());
            _local3.setYPos(this.crystalMain.getCenterY());
            this.tooltipItems[_local2] = _local3;
            _local3.alpha = 0;
            addChild(_local3);
            this.doEaseInAnimation(_local3, {"alpha": 1});
            this.currenttooltipItem = _local2;
        ...
        private function removeItemSwitch():void
        {
            ...
            while (_local1 < 2)
            {
                if (((!((this.tooltipItems[_local1] == null))) && (!((this.tooltipItems[_local1].parent == null)))))
                {
                    this.tooltipItems[_local1].alpha = 0;
        ...
        private function doEaseInAnimation(_arg1:DisplayObject, _arg2:Object = null, _arg3:Function = null):void
        {
            var _local4:GTween = new GTween(
                    _arg1, 0.5, _arg2, {
                        "ease": Sine.easeOut, "onComplete": _arg3
                    }
            );
        }
        ...
        {
            var _local1:ImageSprite;
            this.platformMain = new Sprite();
            _local1 = new ImageSprite(new fortunePlatformEmbed2(), 500, 500);
            _local1.x = (-(_local1.width) / 2);
            _local1.y = (-(_local1.height) / 2);
            this.platformMain.addChild(_local1);
            ...
            _local1 = new ImageSprite(new fortunePlatformEmbed(), 700, 700);
            _local1.x = (-(_local1.width) / 2);
            _local1.y = (-(_local1.height) / 2);
            this.platformMainSub.addChild(_local1);
        ...
        private function onBuyWithGoldClick(_arg1:MouseEvent):void
        {
            this.onFirstBuySub(Currency.GOLD);
        }

        private function onBuyWithFortuneClick(_arg1:MouseEvent):void
        {
            this.onFirstBuySub(Currency.FORTUNE);
        }

        private function onFirstBuySub(_arg1:int):void
        {
            ...
            if ((((this.state == STATE_ROUND_1)) && (!(this.client.requestInProgress()))))
            {
                ...
                if (_local2 != null)
                {
                    ...
                    {
                        _local2.credits_ = (_local2.credits_ - this.goldPrice_);
        ...
        private function onFirstBuyComplete(_arg1:Boolean, _arg2:*):void
        {
            ...
            if (_arg1)
            {
                ...
                this.items = _local3.Candidates.split(",");
                ...
                _local8 = this.crystalMain.getCenterX();
                _local9 = this.crystalMain.getCenterY();
                _local10 = this.crystals[_local5[_local6]].getCenterX();
                ...
                for each (_local17 in this.items)
                {
                    if (_local12 == 0)
                    {
                        new TimerCallback(_local15, this.doLightning, _local8, _local9, _local10, _local11);
        ...
        private function onFirstBuyAnimateSub():void
        {
            ...
            while (_local1 < 3)
            {
                ...
                this.crystals[_local1].saveReturnPotion();
        ...
        private function onFirstBuyAnimateComplete():void
        {
            ...
            while (_local1 < 3)
            {
                if (!(((this.state == STATE_ROUND_2)) && ((this.crystals[_local1] == this.crystalClicked))))
                {
                    this.crystals[_local1].setActive2();
                    this.crystals[_local1].doItemReturn();
                    new TimerCallback(
                            this.NOVA_DELAY_TIME,
                            this.doNova,
                            int(this.crystals[_local1].returnCenterX()),
                            int(this.crystals[_local1].returnCenterY()),
                            5,
                            0xFFFF
                    );
            ...
            new TimerCallback(
                    this.NOVA_DELAY_TIME, this.crystalMain.setAnimationStage, CrystalMain.ANIMATION_STAGE_PULSE
            );
        ...
        {
            var _local1:OpenDialogSignal;
            _local1 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
            ...
            _local2.addEventListener(Dialog.LEFT_BUTTON, this.onErrorOk, false, 0, true);
            _local1.dispatch(_local2);
        }

        private function onErrorOk(_arg1:Event):void
        {
            var _local2:CloseDialogsSignal;
            _local2 = StaticInjectorContext.getInjector().getInstance(CloseDialogsSignal);
            _local2.dispatch();
        }
        ...
        private function fortuneEventOver():void
        {
            var _local1:OpenDialogSignal;
            _local1 = StaticInjectorContext.getInjector().getInstance(OpenDialogSignal);
            _local1.dispatch(new DebugDialog("The Alchemist has left the Nexus.Please check back later.", "Oh no!"));
        }

        private function makeBasicParams():Object
        {
            var _local1:Object = this.account.getCredentials();
            _local1.gameId = this.fortuneInfo.id;
            return (_local1);
        }

        private function onSmallBallClick(_arg1:MouseEvent):void
        {
            this.smallBallClick(_arg1.currentTarget);
        }

        private function smallBallClick(_arg1:Object):void
        {
            var _local2:int;
            var _local3:int;
            while (_local3 < 3)
        ...
        private function smallBallClickSub(_arg1:int, _arg2:int):void
        {
            var _local3:Object = this.makeBasicParams();
        ...
        private function onSmallBallClickComplete(_arg1:Boolean, _arg2:*):void
        {
            ...
            if (_arg1)
            {
                ...
                if (this.state == STATE_ROUND_2)
                {
                    new TimerCallback(
                            0.25,
                            this.doNova,
                            this.crystalClicked.getCenterX(),
                            this.crystalClicked.getCenterY(),
                            6,
                            0xFFFF
                    );
                ...
                else
                {
                    if (this.state == STATE_ROUND_1)
                    {
                        ...
                        new TimerCallback(
                                this.DISPLAY_PRIZE_TIME_1, this.onSmallBallClickCompleteRound2, _local3.Awards
                        );
                        new TimerCallback(
                                0.25,
                                this.doNova,
            ...
            else
            {
                ...
                if (this.state == STATE_ROUND_1)
                {
                    _local4.dispatch(
                            new DebugDialog(
                                    "You have run out of time to choose, but an item has been chosen for you.", "Oh no!"
                            )
                    );
                }
                else
        ...
        private function ballClickEnable(_arg1:CrystalSmall = null):void
        {
            ...
            while (_local2 < 3)
            {
                if (this.crystals[_local2] == _arg1)
                {
                    this.crystals[_local2].removeEventListener(MouseEvent.CLICK, this.onSmallBallClick);
                }
                else
                {
        ...
        {
            var _local3:Number;
            var _local1:int = INIT_RADIUS_FROM_MAINCRYTAL;
            var _local2:int;
            while (_local2 < 3)
            {
                _local3 = (((((_local2 + 1) * 120) - 60) * Math.PI) / 180);
                this.crystals[_local2].setXPos((this.crystalMain.getCenterX() + (_local1 * Math.sin(_local3))));
                this.crystals[_local2].setYPos((this.crystalMain.getCenterY() + (_local1 * Math.cos(_local3))));
                if (this.crystals[_local2].parent == null)
                {
                    addChild(this.crystals[_local2]);
                }
                else
                {
        ...
        private function resetBallsRound2():void
        {
            var _local4:Number;
            var _local1:int;
            var _local2:int = INIT_RADIUS_FROM_MAINCRYTAL;
        ...
        public function rotateAroundCenter(_arg1:DisplayObject, _arg2:Number):void
        {
            if (_arg2 < 0)
            {
                _arg2 = (_arg2 * -1);
        ...
        {
            this.crystalMain.drawAnimation(_arg1, _arg2);
            this.particleMap.update(_arg1, _arg2);
            this.particleMap.draw(null, _arg1);
            this.lastUpdate_ = _arg1;
        }

        private function doNova(_arg1:Number, _arg2:Number, _arg3:int = 20, _arg4:int = 12447231):void
        {
            var _local5:GameObject;
            var _local6:NovaEffect;
            if (this.particleMap != null)
            {
                _local5 = new GameObject(null);
                _local5.x_ = ParticleModalMap.getLocalPos(_arg1);
        ...
        private function doLightning(
                _arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:int = 200, _arg6:int = 12447231
        ):void
        {
            if (this.parent == null)
            {
            ...
            _local8.x_ = ParticleModalMap.getLocalPos(_arg3);
            _local8.y_ = ParticleModalMap.getLocalPos(_arg4);
            var _local9:LightningEffect = new LightningEffect(_local7, _local8, _arg6, _arg5);
            this.particleMap.addObj(_local9, _local7.x_, _local7.y_);
        }

        private function setGameStage(_arg1:int):void
        {
            this.gameStage_ = _arg1;
        }
    }
}
