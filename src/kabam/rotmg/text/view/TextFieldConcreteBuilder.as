package kabam.rotmg.text.view
{
    ...
    public class TextFieldConcreteBuilder
    {
        ...
        public function getLocalizedTextObject(
                _arg1:String,
                _arg2:int = -1,
                _arg3:int = -1,
                _arg4:int = 16,
        ...
        public function getLiteralTextObject(
                _arg1:String,
                _arg2:int = -1,
                _arg3:int = -1,
                _arg4:int = 16,
        ...
        public function getBlankFormattedTextObject(
                _arg1:String,
                _arg2:int = -1,
                _arg3:int = -1,
                _arg4:int = 16,
        ...
        public function formatExistingTextObject(
                _arg1:TextFieldDisplayConcrete,
                _arg2:int = -1,
                _arg3:int = -1,
                _arg4:int = 16,
                _arg5:int = 0xFFFFFF,
        ...
        private function defaultFormatTFDC(
                _arg1:TextFieldDisplayConcrete,
                _arg2:int = -1,
                _arg3:int = -1,
                _arg4:int = 16,
