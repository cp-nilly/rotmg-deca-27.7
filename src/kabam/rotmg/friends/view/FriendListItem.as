package kabam.rotmg.friends.view
{
    ...
    public class FriendListItem extends FListItem
    {
        ...
        override protected function init(_arg1:Number, _arg2:Number):void
        {
            ...
            this._nameText = new TextFieldDisplayConcrete().setSize(18).setColor(
                    ((this._isOnline) ? this.ONLINE_COLOR : this.NORMAL_COLOR)
            );
            ...
            this._jumpButton = _local3.create(
                    AssetLibrary.getImageFromSet("lofiInterface2", 3), TextKey.FRIEND_TELEPORT_TITLE, "", ""
            );
            ...
            this._whisperButton = _local3.create(
                    AssetLibrary.getImageFromSet("lofiInterfaceBig", 21), TextKey.PLAYERMENU_PM, "", ""
            );
            ...
            this._removeButton = new FriendRemoveButton(
                    TextKey.FRIEND_REMOVE_BUTTON, TextKey.FRIEND_REMOVE_BUTTON_DESC
            );
