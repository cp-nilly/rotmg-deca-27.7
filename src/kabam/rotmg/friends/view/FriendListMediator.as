package kabam.rotmg.friends.view
{
    ...
    public class FriendListMediator extends Mediator
    {
        ...
        private function initView(_arg1:Boolean = false)
        {
            ...
            {
                this.view.init(
                        this.model.getAllFriends(), this.model.getAllInvitations(), this.model.getCurrentServerName()
                );
            }
            else
            {
        ...
        private function onFriendActed(_arg1:String, _arg2:String):void
        {
            ...
            switch (_arg1)
            {
                case FriendConstant.SEARCH:
                    if (((!((_arg2 == null))) && (!((_arg2 == "")))))
                    {
                        this.view.updateFriendTab(
                                this.model.getFilterFriends(_arg2), this.model.getCurrentServerName()
                        );
                    }
                    else
                    {
                ...
                case FriendConstant.REMOVE:
                    ...
                    this.openDialog.dispatch(
                            new FriendUpdateConfirmDialog(
                                    _local4,
                                    _local5,
                                    TextKey.FRAME_CANCEL,
                                    TextKey.FRIEND_REMOVE_BUTTON,
                                    _local3,
                                    {"name": _local3.target}
                            )
                    );
