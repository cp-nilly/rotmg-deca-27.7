package kabam.rotmg.packages.view
{
    ...
    public class PackageInfoDialog extends Sprite 
    {
        ...
        public function setTitle(_arg1:String):PackageInfoDialog
        {
            this.title.setStringBuilder(new LineBuilder().setParams(_arg1));
            return (this);
        }

        public function setBody(_arg1:String, _arg2:String):PackageInfoDialog
        {
            this.messageTitle.setStringBuilder(new LineBuilder().setParams(_arg1));
            this.messageBody.setStringBuilder(new LineBuilder().setParams(_arg2));
            return (this);
        }
        ...
        private function makeTitle():TextFieldDisplayConcrete
        {
            ...
            _local1 = new TextFieldDisplayConcrete().setSize(18).setColor(0xB6B6B6).setTextWidth(DIALOG_WIDTH).setAutoSize(TextFormatAlign.CENTER).setBold(true);
            _local1.y = TITLE_Y;
            addChild(_local1);
            return (_local1);
        }
