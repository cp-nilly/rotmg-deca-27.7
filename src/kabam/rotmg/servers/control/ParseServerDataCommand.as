package kabam.rotmg.servers.control
{
    ...
    public class ParseServerDataCommand
    {
        ...
        {
            return (new Server().setName(_arg1.Name).setAddress(_arg1.DNS).setPort(Parameters.PORT).setLatLong(
                    Number(_arg1.Lat), Number(_arg1.Long)
            ).setUsage(_arg1.Usage).setIsAdminOnly(_arg1.hasOwnProperty("AdminOnly")));
        }
    }
}
