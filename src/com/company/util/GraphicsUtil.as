package com.company.util
{
    ...
    public class GraphicsUtil
    {
        ...
        public static const QUAD_COMMANDS:Vector.<int> = new <int>[
            GraphicsPathCommand.MOVE_TO,
            GraphicsPathCommand.LINE_TO,
            GraphicsPathCommand.LINE_TO,
            GraphicsPathCommand.LINE_TO
        ];
        public static const DEBUG_STROKE:GraphicsStroke = new GraphicsStroke(
                1, false, LineScaleMode.NORMAL, CapsStyle.NONE, JointStyle.ROUND, 3, new GraphicsSolidFill(0xFF0000)
        );
        ...
        public static function getRectPath(_arg1:int, _arg2:int, _arg3:int, _arg4:int):GraphicsPath
        {
            return (new GraphicsPath(
                    QUAD_COMMANDS, new <Number>[
                        _arg1, _arg2, (_arg1 + _arg3), _arg2, (_arg1 + _arg3), (_arg2 + _arg4), _arg1, (_arg2 + _arg4)
                    ]
            ));
        }

        public static function getGradientMatrix(
                _arg1:Number, _arg2:Number, _arg3:Number = 0, _arg4:Number = 0, _arg5:Number = 0
        ):Matrix
        {
        ...
        public static function drawCircle(
                _arg1:Number, _arg2:Number, _arg3:Number, _arg4:GraphicsPath, _arg5:int = 8
        ):void
        {
            var _local8:Number;
            var _local9:Number;
        ...
        public static function drawCutEdgeRect(
                _arg1:int, _arg2:int, _arg3:int, _arg4:int, _arg5:int, _arg6:Array, _arg7:GraphicsPath
        ):void
        {
            if (_arg6[0] != 0)
            {
