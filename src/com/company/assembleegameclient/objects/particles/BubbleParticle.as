package com.company.assembleegameclient.objects.particles
{
    ...
    public class BubbleParticle extends Particle
    {
        ...
        public static function create(
                _arg1:*, _arg2:uint, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Number, _arg7:Number
        ):BubbleParticle
        {
        ...
        override public function update(_arg1:int, _arg2:int):Boolean
        {
            ...
            {
                moveTo(
                        (x_ + ((this.frequencyX * _arg2) * this.SPREAD_DAMPER)),
                        (y_ + ((this.frequencyY * _arg2) * this.SPREAD_DAMPER))
                );
            }
            return (true);
        }
