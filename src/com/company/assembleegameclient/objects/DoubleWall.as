    ...
    public class DoubleWall extends GameObject 
    {
        ...
        override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void
        {
            ...
            while (_local5 < this.faces_.length)
            {
                ...
                if ((((((_local8 == null)) || ((_local8.texture_ == null)))) || (((((!((_local8 == null))) && ((_local8.obj_ is DoubleWall)))) && (!(_local8.obj_.dead_))))))
                {
        ...
        public function rebuild3D():void
        {
            ...
            this.addWall((_local1 + 1), _local2, 2, (_local1 + 1), (_local2 + 1), 2);
            this.addWall((_local1 + 1), (_local2 + 1), 2, _local1, (_local2 + 1), 2);
