package com.company.assembleegameclient.objects
{
    ...
    public class GameObject extends BasicObject
    {
        ...
        public function damage(_arg1:int, _arg2:int, _arg3:Vector.<uint>, _arg4:Boolean, _arg5:Projectile):void
        {
            ...
            var _local11:CharacterStatusText;
            var _local12:PetsModel;
            var _local13:PetVO;
            var _local14:String;
            ...
            else
            {
                if (_arg3 != null)
                {
                    ...
                    {
                        _local10 = null;
                        if (((((!((_arg5 == null))) && (_arg5.projProps_.isPetEffect_))) && (_arg5.projProps_.isPetEffect_[_local9])))
                        {
                        ...
                        else
                        {
                            switch (_local9)
                            {
                                ...
                                case ConditionEffect.SLOWED:
                                    ...
                                    {
                                        _local11 = new CharacterStatusText(this, 0xFF0000, 3000);
            ...
            else
            {
                if (_arg5 != null)
                {
                    map_.addObj(new HitEffect(_local7, this.size_, 10, _arg5.angle_, _arg5.projProps_.speed_), x_, y_);
                }
                else
                {
