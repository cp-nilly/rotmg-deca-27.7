package com.company.assembleegameclient.objects
{
    ...
    public class Stalagmite extends GameObject
    {
        ...
        public function Stalagmite(_arg1:XML)
        {
            ...
            obj3D_ = new Object3D();
            obj3D_.vL_.push(
                    (Math.cos(_local2) * 0.3),
                    (Math.sin(_local2) * 0.3),
                    0,
                    (Math.cos(_local3) * 0.3),
                    (Math.sin(_local3) * 0.3),
                    0,
                    (Math.cos(_local4) * 0.3),
                    (Math.sin(_local4) * 0.3),
                    0,
                    0,
                    0,
                    (0.6 + (0.6 * Math.random()))
            ...
            obj3D_.faces_.push(
                    new ObjectFace3D(obj3D_, new <int>[0, 1, 3]),
                    new ObjectFace3D(obj3D_, new <int>[1, 2, 3]),
                    new ObjectFace3D(obj3D_, new <int>[2, 0, 3])
            );
