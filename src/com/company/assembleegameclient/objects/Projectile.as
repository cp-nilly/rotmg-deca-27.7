package com.company.assembleegameclient.objects
{
    ...
    public class Projectile extends BasicObject
    {
        ...
        ):void
        {
            ...
            var _local9:String = ((((!((_arg7 == ""))) && ((this.projProps_.objectId_ == _arg8))))
                    ? _arg7
                    : this.projProps_.objectId_);
        ...
        override public function update(_arg1:int, _arg2:int):Boolean
        {
            ...
            if (((!(this.moveTo(_local4.x, _local4.y))) || ((square_.tileType_ == 0xFFFF))))
            {
                ...
                else
                {
                    if (square_.obj_ != null)
                    {
                        ...
                        map_.addObj(
                                new HitEffect(_local5, 100, 3, this.angle_, this.projProps_.speed_),
                                _local4.x,
                                _local4.y
                        );
                    }
            ...
            if (((((!((square_.obj_ == null))) && (((!(square_.obj_.props_.isEnemy_)) || (!(this.damagesEnemies_)))))) && (((square_.obj_.props_.enemyOccupySquare_) || (((!(this.projProps_.passesCover_)) && (square_.obj_.props_.occupySquare_)))))))
            {
                ...
                else
                {
                    _local5 = BloodComposition.getColors(this.texture_);
                    map_.addObj(
                            new HitEffect(_local5, 100, 3, this.angle_, this.projProps_.speed_), _local4.x, _local4.y
                    );
                }
                return (false);
            }
            ...
            if (_local6 != null)
            {
                ...
                if (_local10)
                {
                    _local11 = GameObject.damageWithDefense(
                            this.damage_, _local6.defense_, this.projProps_.armorPiercing_, _local6.condition_
                    );
                    _local12 = false;
        ...
        override public function draw(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void
        {
            ...
            this.p_.draw(
                    _arg1,
                    this.staticVector3D_,
                    (((this.angle_ - _arg2.angleRad_) + this.props_.angleCorrection_) + _local5),
                    _arg2.wToS_,
                    _arg2,
                    _local4
            );
            ...
            {
                _local8 = (((this.projProps_.particleTrailLifetimeMS) != -1)
                        ? this.projProps_.particleTrailLifetimeMS
                        : 600);
                _local9 = 0;
                for (; _local9 < 3; _local9++)
                {
                    ...
                    map_.addObj(
                            new SparkParticle(
                                    100,
                                    this.projProps_.particleTrailColor_,
                                    _local8,
                                    0.5,
                                    RandomUtil.plusMinus(3),
                                    RandomUtil.plusMinus(3)
                            ), x_, y_
                    );
                }
        ...
        override public function drawShadow(_arg1:Vector.<IGraphicsData>, _arg2:Camera, _arg3:int):void
        {
            ...
            Vector.<Number>(this.shadowPath_.data).push(
                    (posS_[0] - _local5),
                    (posS_[1] - _local6),
                    (posS_[0] + _local5),
                    (posS_[1] - _local6),
