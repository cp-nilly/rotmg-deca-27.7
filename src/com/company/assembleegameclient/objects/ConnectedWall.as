package com.company.assembleegameclient.objects
{
    ...
    public class ConnectedWall extends ConnectedObject
    {
        ...
        override protected function buildDot():void
        {
            ...
            {
                _local9 = AssetLibrary.getImageFromSet(
                        String(this.objectXML_.DotTexture.File), int(this.objectXML_.DotTexture.Index)
                );
            }
            this.addTop(
                    [
                        _local5, _local6, _local7, _local8
                    ], new <Number>[0.25, 0.25, 0.75, 0.25, 0.25, 0.75], _local9
            );
        }
        ...
        override protected function buildShortLine():void
        {
            ...
            {
                _local9 = AssetLibrary.getImageFromSet(
                        String(this.objectXML_.ShortLineTexture.File), int(this.objectXML_.ShortLineTexture.Index)
                );
            }
        ...
        override protected function buildL():void
        {
            ...
            {
                _local13 = AssetLibrary.getImageFromSet(
                        String(this.objectXML_.LTexture.File), int(this.objectXML_.LTexture.Index)
                );
            }
            this.addTop(
                    [
                        _local7, _local8, _local9, _local10, _local11, _local12
                    ], new <Number>[0.25, 0, 0.75, 0, 0.25, 0.75], _local13
            );
        }
        ...
        override protected function buildLine():void
        {
            ...
            {
                _local9 = AssetLibrary.getImageFromSet(
                        String(this.objectXML_.LineTexture.File), int(this.objectXML_.LineTexture.Index)
                );
            }
        ...
        override protected function buildT():void
        {
            ...
            {
                _local17 = AssetLibrary.getImageFromSet(
                        String(this.objectXML_.TTexture.File), int(this.objectXML_.TTexture.Index)
                );
            }
            this.addTop(
                    [
                        _local9, _local10, _local11, _local12, _local13, _local14, _local15, _local16
                    ], new <Number>[0.25, 0, 0.75, 0, 0.25, 0.25], _local17
            );
        }
        ...
        override protected function buildCross():void
        {
            ...
            {
                _local25 = AssetLibrary.getImageFromSet(
                        String(this.objectXML_.CrossTexture.File), int(this.objectXML_.CrossTexture.Index)
                );
            }
            this.addTop(
                    [
                    ...
                    new <Number>[0.25, 0, 0.75, 0, 0.25, 0.25],
                    _local25
            );
        }

        protected function addQuad(
                _arg1:Vector3D,
                _arg2:Vector3D,
                _arg3:Vector3D,
                _arg4:Vector3D,
        ...
        ):void
        {
            ...
            var _local9:Number = ((_arg6) ? (-((this.bI_ - this.tI_)) / ((1 - (this.bI_ - this.tI_)) - ((_arg7)
                    ? (this.bI_ - this.tI_)
                    : 0))) : 0);
            obj3D_.uvts_.push(0, 0, 0, 1, 0, 0, 1, 1, 0, _local9, 1, 0);
            var _local10:ObjectFace3D = new ObjectFace3D(
                    obj3D_, new <int>[_local8, (_local8 + 1), (_local8 + 2), (_local8 + 3)]
            );
        ...
        ):void
        {
            ...
            var _local11:ObjectFace3D = new ObjectFace3D(
                    obj3D_, new <int>[_local10, (_local10 + 1), (_local10 + 2), (_local10 + 3)]
            );
            ...
            else
            {
                if (_arg8)
                {
                    if (_arg9)
                    {
                        _local12 = Vector.<Number>(
                                [
                                    -0.75, 0.5, 0, 0, 0, -0.5, 0.5, 0, 1, 0, -0.75, -0.5, 0, 0, 1, -0.5, -0.5, 0, 1, 1
                                ]
                        );
                    }
                    else
                    {
                        _local12 = Vector.<Number>(
                                [
                                    0.5, 0.5, 0, 0, 0, 0.75, 0.5, 0, 1, 0, 0.5, -0.5, 0, 0, 1, 0.75, -0.5, 0, 1, 1
                                ]
                        );
                    }
        ...
        protected function addTop(_arg1:Array, _arg2:Vector.<Number>, _arg3:BitmapData):void
        {
            ...
            if ((((((_local5.length == 4)) && ((GraphicsFillExtra.getVertexBuffer(_local7.bitmapFill_) == null)))) && (Parameters.isGpuRender())))
            {
                ...
                while (_local9 < _local5.length)
                {
                    ...
                    _local10.push(
                            obj3D_.vL_[(_local5[_local11] * 3)],
                            (obj3D_.vL_[((_local5[_local11] * 3) + 1)] * -1),
                            obj3D_.vL_[((_local5[_local11] * 3) + 2)],
                            obj3D_.uvts_[(_local5[(((_local11) != 2) ? _local11 : (_local11 - 1))] * 3)],
                            obj3D_.uvts_[((_local5[(((_local11) != 2) ? _local11 : (_local11 + 1))] * 3) + 1)]
                    );
                    _local9++;
                }
                ...
                if ((((((_local5.length == 6)) && ((GraphicsFillExtra.getVertexBuffer(_local7.bitmapFill_) == null)))) && (Parameters.isGpuRender())))
                {
                    ...
                    while (_local15 < 2)
                    {
                        ...
                        for each (_local9 in _local12)
                        {
                            ...
                            _local10.push(
                                    obj3D_.vL_[(_local5[_local9] * 3)],
                                    (obj3D_.vL_[((_local5[_local9] * 3) + 1)] * -1),
                                    obj3D_.vL_[((_local5[_local9] * 3) + 2)],
                                    obj3D_.uvts_[(_local5[(((_local17) != 2) ? _local17 : (_local17 - 1))] * 3)],
                                    obj3D_.uvts_[((_local5[(((_local17) != 2) ? _local17 : (_local17 + 1))] * 3) + 1)]
                            );
                            _local16++;
                        }
                        if (_local15 == 1)
