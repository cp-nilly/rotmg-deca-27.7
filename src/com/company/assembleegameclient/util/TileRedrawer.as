package com.company.assembleegameclient.util
{
    ...
    public class TileRedrawer
    {
        ...
        private static function redrawRect(
                _arg1:BitmapData,
                _arg2:Rectangle,
                _arg3:Point,
                _arg4:Vector.<ImageSet>,
                _arg5:uint,
                _arg6:uint,
                _arg7:uint,
                _arg8:uint
        ):void
        {
            ...
            else
            {
                if (((!((_arg5 == _arg6))) && (!((_arg5 == _arg8)))))
                {
                    ...
                    {
                        _arg1.copyPixels(
                                GroundLibrary.getBitmapData(_arg6), _arg2, _arg3, _arg4[INNERP1].random(), p0, true
                        );
                        _arg1.copyPixels(
                                GroundLibrary.getBitmapData(_arg8), _arg2, _arg3, _arg4[INNERP2].random(), p0, true
                        );
                        return;
                    }
        ...
        private static function getMasks():Vector.<Vector.<ImageSet>>
        {
            ...
            addMasks(
                    _local1,
                    AssetLibrary.getImageSet("inner_mask"),
                    AssetLibrary.getImageSet("sides_mask"),
                    AssetLibrary.getImageSet("outer_mask"),
                    AssetLibrary.getImageSet("innerP1_mask"),
                    AssetLibrary.getImageSet("innerP2_mask")
            );
            return (_local1);
        }

        private static function addMasks(
                _arg1:Vector.<Vector.<ImageSet>>,
                _arg2:ImageSet,
                _arg3:ImageSet,
                _arg4:ImageSet,
                _arg5:ImageSet,
        ...
        ):void
        {
            ...
            for each (_local7 in [-1, 0, 2, 1])
            {
                _arg1.push(
                        new <ImageSet>[
                            rotateImageSet(_arg2, _local7),
                            rotateImageSet(_arg3, (_local7 - 1)),
                            rotateImageSet(_arg3, _local7),
                            rotateImageSet(_arg4, _local7),
                            rotateImageSet(_arg5, _local7),
                            rotateImageSet(_arg6, _local7)
                        ]
                );
            }
        }
        ...
        private static function getCompositeSig(_arg1:Square):ByteArray
        {
            ...
            if ((((_local10 < 0)) && ((_local11 < 0))))
            {
                ...
                _local2[0] = (((((_local14 == null)) || ((_local14.props_.compositePriority_ < 0))))
                        ? 0xFF
                        : _local14.tileType_);
            }
            else
            ...
            if ((((_local10 < 0)) && ((_local12 < 0))))
            {
                ...
                _local2[1] = (((((_local15 == null)) || ((_local15.props_.compositePriority_ < 0))))
                        ? 0xFF
                        : _local15.tileType_);
            }
            else
            ...
            if ((((_local11 < 0)) && ((_local13 < 0))))
            {
                ...
                _local2[2] = (((((_local16 == null)) || ((_local16.props_.compositePriority_ < 0))))
                        ? 0xFF
                        : _local16.tileType_);
            }
            else
            ...
            if ((((_local12 < 0)) && ((_local13 < 0))))
            {
                ...
                _local2[3] = (((((_local17 == null)) || ((_local17.props_.compositePriority_ < 0))))
                        ? 0xFF
                        : _local17.tileType_);
            }
            else
