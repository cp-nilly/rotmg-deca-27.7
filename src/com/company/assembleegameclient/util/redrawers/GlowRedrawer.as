package com.company.assembleegameclient.util.redrawers
{
    ...
    public class GlowRedrawer
    {
        ...
        private static const GLOW_FILTER:GlowFilter = new GlowFilter(
                0, 0.3, 12, 12, 2, BitmapFilterQuality.LOW, false, false
        );
        private static const GLOW_FILTER_ALT:GlowFilter = new GlowFilter(
                0, 0.5, 16, 16, 3, BitmapFilterQuality.LOW, false, false
        );
        ...
        public static function outlineGlow(
                _arg1:BitmapData, _arg2:uint, _arg3:Number = 1.4, _arg4:Boolean = false
        ):BitmapData
        {
        ...
        private static function getGradient():Shape
        {
            ...
            _local1.graphics.beginGradientFill(
                    GradientType.LINEAR, [
                        0, GRADIENT_MAX_SUB
                    ], [
                        1, 1
