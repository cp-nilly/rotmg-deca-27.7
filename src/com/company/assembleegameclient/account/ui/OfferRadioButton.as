package com.company.assembleegameclient.account.ui
{
    ...
    public class OfferRadioButton extends Sprite implements Selectable
    {
        ...
        public function OfferRadioButton(_arg1:Offer, _arg2:MoneyConfig)
        {
            this.offer = _arg1;
            this.config = _arg2;
        ...
        {
            var _local1:int = ((this.isSelected) ? SELECTED_COLOR : ((this.isOver) ? OVER_COLOR : DEFAULT_COLOR));
