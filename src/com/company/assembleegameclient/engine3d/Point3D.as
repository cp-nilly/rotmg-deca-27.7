package com.company.assembleegameclient.engine3d
{
    ...
    {
        private static const commands_:Vector.<int> = new <int>[
        ...
        ):void
        {
            ...
            {
                this.data_.push(
                        (this.posS_.x - _local9),
                        (this.posS_.y - _local9),
                        (this.posS_.x + _local9),
                        (this.posS_.y - _local9),
                        (this.posS_.x + _local9),
                        (this.posS_.y + _local9),
            ...
            else
            {
                ...
                this.data_.push(
                        (this.posS_.x + ((_local10 * -(_local9)) + (_local11 * -(_local9)))),
                        (this.posS_.y + ((_local11 * -(_local9)) - (_local10 * -(_local9)))),
                        (this.posS_.x + ((_local10 * _local9) + (_local11 * -(_local9)))),
                        (this.posS_.y + ((_local11 * _local9) - (_local10 * -(_local9)))),
                        (this.posS_.x + ((_local10 * _local9) + (_local11 * _local9))),
                        (this.posS_.y + ((_local11 * _local9) - (_local10 * _local9))),
