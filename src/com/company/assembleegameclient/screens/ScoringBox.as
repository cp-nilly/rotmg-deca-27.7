package com.company.assembleegameclient.screens
{
    ...
    public class ScoringBox extends Sprite
    {
        ...
        public function ScoringBox(_arg1:Rectangle, _arg2:XML)
        {
            ...
            {
                this.addLine(
                        TextKey.FAMEVIEW_ACCURACY,
                        null,
                        0,
                        ((100 * Number(_arg2.ShotsThatDamage)) / Number(_arg2.Shots)),
                        true,
                        5746018,
                        "",
                        "%"
            ...
            this.addLine(
                    TextKey.FAMEVIEW_DUNGEONSCOMPLETED,
                    null,
                    0,
                    ((((((int(_arg2.PirateCavesCompleted) + int(_arg2.UndeadLairsCompleted)) + int(_arg2.AbyssOfDemonsCompleted)) + int(_arg2.SnakePitsCompleted)) + int(_arg2.SpiderDensCompleted)) + int(_arg2.SpriteWorldsCompleted)) + int(_arg2.TombsCompleted)),
                    false,
                    5746018
            );
            ...
            this.addLine(
                    TextKey.FAMEVIEW_BASEFAMEEARNED,
                    null,
                    0,
                    _arg2.BaseFame,
                    true,
        ...
        ):void
        {
            ...
            this.scoreTextLines_.push(
                    new ScoreTextLine(
                            20, 0xB3B3B3, _arg6, _arg1, _arg2, _arg3, _arg4, _arg7, _arg8, _arg9
                    )
            );
        }
        ...
        private function onEnterFrame(_arg1:Event):void
        {
            ...
            _local3 = getTimer();
            var _local4:int = Math.min(
                    this.scoreTextLines_.length, (((2 * (getTimer() - this.startTime_)) / 2000) + 1)
            );
            var _local5:int;
