package com.company.assembleegameclient.screens.charrects
{
    ...
    public class CreateNewCharacterRect extends CharacterRect
    {
            ...
            if (_arg1.getNumStars() != FameUtil.maxStars())
            {
                ...
                super.makeTaglineText(
                        new LineBuilder().setParams(
                                TextKey.CREATE_NEW_CHARACTER_RECT_TAGLINE, {"remainingStars": _local2}
                        )
                );
        ...
        public function makeBitmap():void
        {
            ...
            var _local2:BitmapData = SavedCharacter.getImage(
                    null, _local1, AnimatedChar.RIGHT, AnimatedChar.STAND, 0, false, false
            );
