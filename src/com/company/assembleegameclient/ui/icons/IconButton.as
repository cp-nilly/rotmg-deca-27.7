package com.company.assembleegameclient.ui.icons
{
    ...
    public class IconButton extends Sprite implements TooltipAble
    {
        ...
        public function IconButton(_arg1:BitmapData, _arg2:String, _arg3:String, _arg4:String = "")
        {
            ...
            this.iconBitmapData_ = TextureRedrawer.redraw(
                    this.origIconBitmapData_, (320 / this.origIconBitmapData_.width), true, 0
            );
            ...
            {
                this.setToolTipText(
                        TextKey.ICON_BUTTON_HOT_KEY,
                        {"hotkey": KeyCodes.CharCodeStrings[Parameters.data_[this.hotkeyName_]]}
                );
            }
        }
