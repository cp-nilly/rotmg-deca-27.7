package com.company.assembleegameclient.ui.menu
{
    ...
    public class PlayerMenu extends Menu
    {
        ...
        public function initDifferentServer(
                _arg1:AGameSprite, _arg2:String, _arg3:Boolean = false, _arg4:Boolean = false
        ):void
        {
            ...
            _local5 = new MenuOption(
                    AssetLibrary.getImageFromSet("lofiInterfaceBig", 21), 0xFFFFFF, TextKey.PLAYERMENU_PM
            );
            _local5.addEventListener(MouseEvent.CLICK, this.onPrivateMessage);
            addOption(_local5);
            _local5 = new MenuOption(
                    AssetLibrary.getImageFromSet("lotfInterfaceBig", 10), 0xFFFFFF, TextKey.FRIEND_ADD_TITLE
            );
            ...
            {
                _local5 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 21), 0xFFFFFF, TextKey.PLAYERMENU_GUILDCHAT
                );
            ...
            {
                _local5 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 7), 0xFFFFFF, TextKey.PLAYERMENU_TRADE
                );
        ...
        public function init(_arg1:AGameSprite, _arg2:Player):void
        {
            ...
            if (Player.isAdmin)
            {
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 10), 0xFFFFFF, TextKey.PLAYERMENU_KICK
                );
                _local3.addEventListener(MouseEvent.CLICK, this.onKick);
                addOption(_local3);
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 4), 0xFFFFFF, TextKey.PLAYERMENU_MUTE
                );
                _local3.addEventListener(MouseEvent.CLICK, this.onMute);
                addOption(_local3);
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 3), 0xFFFFFF, TextKey.PLAYERMENU_UNMUTE
                );
            ...
            {
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 10), 0xFFFFFF, TextKey.PLAYERMENU_INVITE
                );
            ...
            {
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterface2", 5), 0xFFFFFF, TextKey.PLAYERMENU_LOCK
                );
            ...
            {
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterface2", 6), 0xFFFFFF, TextKey.PLAYERMENU_UNLOCK
                );
            ...
            {
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 8), 0xFFFFFF, TextKey.FRIEND_BLOCK_BUTTON
                );
            ...
            {
                _local3 = new MenuOption(
                        AssetLibrary.getImageFromSet("lofiInterfaceBig", 9), 0xFFFFFF, TextKey.PLAYERMENU_UNIGNORE
                );
