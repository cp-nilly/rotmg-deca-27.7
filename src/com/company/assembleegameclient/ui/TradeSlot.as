package com.company.assembleegameclient.ui
{
    ...
    public class TradeSlot extends Slot implements TooltipAble
    {
        ...
        public function TradeSlot(
                _arg1:int, _arg2:Boolean, _arg3:Boolean, _arg4:int, _arg5:int, _arg6:Array, _arg7:uint
        )
        {
            this.equipmentToolTipFactory = new EquipmentToolTipFactory();
            this.overlayFill_ = new GraphicsSolidFill(16711310, 1);
            this.lineStyle_ = new GraphicsStroke(
                    2, false, LineScaleMode.NORMAL, CapsStyle.NONE, JointStyle.ROUND, 3, this.overlayFill_
            );
        ...
        private function drawItem():void
        {
            ...
            if (((_local2.hasOwnProperty("Doses")) && (this.bitmapFactory)))
            {
                ...
                _local5 = this.bitmapFactory.make(
        ...
        public function setPlayer(_arg1:Player):void
        {
            if (!this.isEmpty())
            {
                this.hoverTooltipDelegate.tooltip = this.equipmentToolTipFactory.make(
                        this.item_, _arg1, -1, InventoryOwnerTypes.OTHER_PLAYER, this.id
                );
            }
        }
