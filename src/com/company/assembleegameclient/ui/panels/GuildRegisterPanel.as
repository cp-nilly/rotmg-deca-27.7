    ...
    public class GuildRegisterPanel extends Panel
    {
        ...
        public function GuildRegisterPanel(_arg1:GameSprite)
        {
            ...
            if (((!((_local2.guildName_ == null))) && ((_local2.guildName_.length > 0))))
            {
                ...
                this.title_.setStringBuilder(
                        new LineBuilder().setParams(
                                TextKey.GUILD_REGISTER_PANEL_RANK, {
                                    "rank": _local3, "guildName": _local2.guildName_
                                }
            ...
            else
            {
                ...
                this.title_.y = 0;
                addChild(this.title_);
                _local4 = new LegacyBuyButton(
                        TextKey.GUILD_REGISTER_PANEL_BUY, 16, Parameters.GUILD_CREATION_PRICE, Currency.FAME
                );
        ...
        private function alignUI():void
        {
            ...
            this.button_.y = (((this.button_ is LegacyBuyButton))
                    ? ((HEIGHT - (this.button_.height / 2)) - 31)
                    : ((HEIGHT - this.button_.height) - 4));
        }
