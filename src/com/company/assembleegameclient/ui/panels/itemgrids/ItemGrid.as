package com.company.assembleegameclient.ui.panels.itemgrids
{
    ...
    public class ItemGrid extends Panel
    {
        ...
        private function addToolTipToTile(_arg1:ItemTile):void
        {
            ...
            {
                this.tooltip = new EquipmentToolTip(
                        _arg1.itemSprite.itemId,
                        this.curPlayer,
                        ((this.owner) ? this.owner.objectType_ : -1),
            ...
            else
            {
                ...
                this.tooltip = new TextToolTip(
                        0x363636,
                        0x9B9B9B,
                        null,
                        TextKey.ITEM_EMPTY_SLOT,
                        200,
                        {"itemType": TextKey.wrapForTokenResolution(_local2)}
                );
            }
